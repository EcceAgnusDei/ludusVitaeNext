...
CREATE TABLE "grid_like" (
	...
	"userId" text NOT NULL,
	"createdAt" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	CONSTRAINT "grid_like_pkey" PRIMARY KEY("gridId","userId")
);
--> statement-breakpoint
...
CREATE INDEX "grid_userId_createdAt_idx" ON "grid" USING btree ("userId" text_ops,"createdAt" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "grid_like_gridId_idx" ON "grid_like" USING btree ("gridId" text_ops);--> statement-breakpoint
CREATE INDEX "grid_like_userId_idx" ON "grid_like" USING btree ("userId" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "user_name_lower_trim_unique" ON "user" USING btree (LOWER(TRIM("name")));--> statement-breakpoint
