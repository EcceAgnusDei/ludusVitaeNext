...
const EDITEUR = {
  nom: "Mondoloni",
  prenom: "Antoine",
  adresse: "9 Lenza di Peru, 20100 Grossa, France",
  email: "mondo.antoine@yahoo.fr",
  //telephone: "",
};
    ...
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8 md:py-12">
      ...
      <div className="space-y-10 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Fournisseur auprès duquel sont stockées les pages et fichiers servis
            aux visiteurs (hébergement du site).
          </p>
          <dl className="grid gap-2 border-l-2 border-border pl-4">
            <div>
